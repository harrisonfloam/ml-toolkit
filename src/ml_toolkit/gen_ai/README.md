...
- lightweight settings via Pydantic (`ml_toolkit.gen_ai.settings`)

## [llm_helpers](../src/ml_toolkit/gen_ai/llm_helpers.py)
...
from ml_toolkit.gen_ai.llm_helpers import create_mistral_client, create_ollama_client
...
```python
from ml_toolkit.gen_ai.llm_helpers import completion
...
```python
from ml_toolkit.gen_ai.llm_helpers import chat_completion
...
```python
from ml_toolkit.gen_ai.llm_helpers import stream_completion
...
```python
from ml_toolkit.gen_ai.llm_helpers import create_ollama_client, list_models
