...
python -m ml_toolkit.quiz_generator

# Override provider/model
python -m ml_toolkit.quiz_generator --provider=ollama --model mistral-small3.2:latest

# Use OpenAI (or any OpenAI-compatible provider)
python -m ml_toolkit.quiz_generator --provider=openai
```
...
```text
$ python -m ml_toolkit.quiz_generator
[INFO] ml_toolkit.quiz_generator.agent: Starting quiz generator agent
[INFO] ml_toolkit.quiz_generator.agent: Provider: ollama
[INFO] ml_toolkit.quiz_generator.agent: Model: mistral-small3.2:latest
...
from ml_toolkit.quiz_generator.ingestor import ingest_arxiv_url
from ml_toolkit.quiz_generator.llm_helpers import create_ollama_client
from ml_toolkit.quiz_generator.orchestrator import plan_and_generate_quiz
...
```python
from ml_toolkit.quiz_generator.agent import build_agent
